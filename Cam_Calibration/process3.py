'''
Sample Usage:- Go to terminal and proper directory- Also do not forget to change the checkerboard width and height
 python process3.py --dir calibration_checkerboard/ --square_size 0.04 --visualize True
'''
